...
if CassiopeiaMenu.Drawings.W:Value() then DrawCircle(pos,800,1,25,GoS.Yellow) end
...
local target2 = TargetSelector(800,TARGET_LESS_CAST_PRIORITY,DAMAGE_MAGIC,true,false)
